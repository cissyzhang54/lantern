  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      let results = {
        ...
        referrer_types: filterOutTerms(format(sectionData.aggregations.referrer.types), ['search', 'unknown', 'partner', 'social-network', 'email']),
        referrer_names: format(sectionData.aggregations.referrer.names),

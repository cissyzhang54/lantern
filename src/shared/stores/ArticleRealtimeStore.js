    ...
    if (this.socket) {
      ...
      this.socket.on('updatedArticleData', (data) => {
        this.setState({
          ...
          internalReferrerTypes : data.realtimeReferrerTypes,
          internalReferrerNames : data.realtimeReferrerNames,
          internalReferrerUrls : data.realtimeReferrerUrls,

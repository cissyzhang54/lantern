export default {
  'explanations.articleHandler.scrollDepth': 'Percentage of the article the user has scrolled through. This is based on the height of the article rather then the height of the page, so the comments section is excluded.',
  ...
  'explanations.sectionWhen.articleViews': `This chart shows page views over time for this article (blue)
  ...
  'explanations.sectionInteract.commentsViewed': 'This shows the number of users who read down to the comment section of the article page'
